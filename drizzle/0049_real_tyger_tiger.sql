...
CREATE TYPE "public"."notification_type" AS ENUM('appointment_reminder', 'appointment_cancelled', 'appointment_completed', 'payment_received', 'payment_overdue', 'payable_due', 'payable_overdue', 'system_update');--> statement-breakpoint
